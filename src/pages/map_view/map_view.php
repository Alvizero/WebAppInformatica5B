...
<body>
  ...
  <div class="layout">
    ...
    <div class="sidebar">
      ...
      <label for="f-lingua">Lingua da cercare</label>
      <input type="text" id="f-lingua" placeholder="es. Italiano">

      <label for="f-nazionalita">Nazionalità da cercare</label>
  ...
  <script>
    ...
    async function searchUsers() {
      ...
      if (!lingua && !nazionalita) {
        alert('Inserisci almeno una lingua o nazionalità da cercare.');
        return;
      }
      if (!inizio || !fine) {
        alert('Inserisci le date del tuo viaggio.');
        return;
      }
